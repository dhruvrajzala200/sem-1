...
/* compare ma evu thase ke banne na first letter check thase ane emni ascii
value check thase 
input---s1:dhruvraj               input---s1:dhruvraj
        s2:zala                           s2:Dhruvraj
output--- s1 is less than s2      output---s2 is less than s1 
